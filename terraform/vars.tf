variable "organization" {
  description = "The name of the organization deploying the infrastructure"
  type = string
  default = "derrickdunville"
}

variable "application" {
  description = "The name of the application"
  type = string
  default = "aws_next_starter"
}

variable "workspace" {
  description = "The name of the organizations workspace for the application"
  type = string
  default = "boilerplate"
}

variable "domain_name" {
  default = "somethingthatbreaks.com"
}
