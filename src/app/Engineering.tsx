...
import {
    ...
    Text,
    Link,
    VStack, Image, HStack, Flex, Stack,
...
export default function Engineering() {
    return (
        <Box bg={COLORS.background} w={"100%"}>
            ...
            <Container>
                <Heading as="h2" size="2xl" color={COLORS.textDark} textAlign="center">
                    Engineering
                </Heading>
                <Stack gap={6} textAlign="center" direction={{ base: "column", md: "row" }} pb={8}>
                    <Box>
                ...
                <VStack gap={8} align="stretch" bg={COLORS.rust} color={COLORS.creamFill} borderRadius="md" pt={"-2px"}>
                    ...
                    <Box p={6} borderRadius="md" >
                        ...
                        <Text>
                            A fun React + Vite app that allows mutliple friends to "paper-trade." Origins began in 2023 as
                            a HTML single page application that only ran on local host. Redone, in 2025-2026, this work showcases
                            foundational React and Vite routing and some fullstack skills. Local Host app was used in a "Wolf of Wallstreet" party
